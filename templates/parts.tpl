...
<div id="main_content">
	<div id="pageBlock"> 
		...
		<div class="GD-30 R text_align_right">
			{if $hvGroups eq '1'}<p><a class="button btn_gray" href="export_datas_grp.php?type={$ptype}" target="_blank">Export To CSV</a></p>{else}<p><a class="button btn_gray" href="export_datas.php?type={$ptype}" target="_blank">Export To CSV</a></p>{/if}
		</div>
					...
					<table>
						<thead>
							<tr>
								...
								{if $hvGroups eq '1'}<th align="left"><a href="#">Stock <!-- <i class="fa fa-angle-down"></i> --></a></th>{/if}
								{if $hvGroups eq '0'}
                                ...
                                {if $ptype eq 2 or $ptype eq 9 or $ptype eq 1 or $ptype eq 10 or $ptype eq 11 or $ptype eq 14}
								...
								{/if}
								{if $ptype eq 9 or $ptype eq 15 or $ptype eq 16}
								...
								{/if}{*<!--  -->*}
                                {if $ptype eq 7 or $ptype eq 8}
									<th align="left"><a href="#">Plug Wires</a></th>
								{/if}
								{if $ptype eq 3 or $ptype eq 4 or $ptype eq 5 or $ptype eq 6 }
						...
						<tbody>            
							...
							<tr class="{cycle values="odd,"} itemrow{$gsreqcnt[i].partid}" id="item-r{$gsreqcnt[i].cnt}">
								...
								{if $hvGroups eq '1'}
								<td align="left" nowrap><span class="MOB">RS Reference:</span> {$gsreqcnt[i].grprsac}</td>
                                ...
                                <td align="left"><span class="MOB">Piston MM:</span> {$gsreqcnt[i].piston_mm}</td>
								<td align="left"><span class="MOB">Pad Gap:</span> {$gsreqcnt[i].pad_gap}</td>
								{/if}
								{if $ptype eq 9 or $ptype eq 15 or $ptype eq 16}
								...
								{/if}{*<!--  -->*}
                                {if $ptype eq 7 or $ptype eq 8 }
									<td align="left"><span class="MOB">Plug Wires:</span> {$gsreqcnt[i].plug_wires}</td>
								{/if}
								{if $ptype eq 3 or $ptype eq 4 or $ptype eq 5 or $ptype eq 6 }
									<td align="left"><span class="MOB">Lock Stops Size:</span> {$gsreqcnt[i].lock_stops_size}</td>
									<td align="left"><span class="MOB">Lock Stops Colour:</span> {$gsreqcnt[i].lock_stops_colour}</td>
								{/if}
								{if $ptype eq 1 or $ptype eq 2 or $ptype eq 9 or $ptype eq 10 or $ptype eq 11}
								...
								<td align="center" nowrap><span class="action">
 									{if $hvGroups eq '1'}<a href="edit_item.php?type={$ptype}&partid={$gsreqcnt[i].partid}" class="tooltip" title="View Details"><i class="fa fa-search"></i></a>{else}<a href="edit_part.php?type={$ptype}&partid={$gsreqcnt[i].partid}" class="tooltip" title="View Details"><i class="fa fa-search"></i></a>{/if}
