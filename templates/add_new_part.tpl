	...
	<div id="pageBlock">
		...
		<div class="GD-70">
			<div class="form_table">
				<form name="frm" method="post" action="add_new_part.php" class="validate disable" onSubmit="return valForm(this)"> 
					<div class="row">
						<table width="100%">
							<thead>
								<tr>
							...
							<tr>
								...
								<td><input name="rsac" type="text" class="input req alphanumeric" value="" maxlength="250" />
								</td>
							...
							<tr>
								<td>A-Grade :</td>
								<td><input name="a_grade" type="text" class="input onlyNumber" value="{$a_grade}" maxlength="8" /></td>
								<td>Target Stock :</td>
								<td><input name="target_stock" type="text" class="input onlyNumber" value="{$target_stock}" maxlength="8" /></td>
							</tr>
							<tr>
								<td>B-Grade :</td>
								<td><input name="b_grade" type="text" class="input onlyNumber" value="{$b_grade}" maxlength="8" /></td>
								<td>Location :</td>
								<td><input name="location" type="text" class="input" value="{$location}" maxlength="250" /></td>
							</tr>
							{/if}
						</table>
						<table width="100%">
