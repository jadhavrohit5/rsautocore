...
<div id="adminBody">
	<div id="pageBlock">
		{if $previd ne ""}<div class="GD-30 L text_align_left">
			<a class="button btn_gray" href="edit_item.php?type={$ptypeid}&partid={$previd}">Prev</a>
		</div>{/if}
		{if $nextid ne ""}<div class="GD-30 R text_align_right">
			<a class="button btn_gray" href="edit_item.php?type={$ptypeid}&partid={$nextid}">Next</a>
		</div>{/if}
		<div class="row text_align_center">
			{if $msg ne ""}<h3 class="redText">{$msg}</h3>{/if}
		</div>
		<div class="box section_edit">
			<form name="frm" method="post" action="edit_item.php?type={$ptypeid}&partid={$partid}" class="validate disable" onSubmit="return valupdForm(this)"> 
				<div class="row">
							...
							<div class="tab-block">
								...
								<div class="tabs-container">
									...
									<div id="oestock-data" class="tab-content">
										...
										<div class="text_align_right"><a href="add_new_stock.php?type={$ptypeid}&partid={$partid}">Add New OE Stock</a>
										</div>
									</div>
