									...
									<div id="oestock-data" class="tab-content">
										<table width="100%">
											...
											<tr>
												...
												{/if}
												<td valign="top">{*<!-- <input name="pid[{$grouppartslist[i].cnt}][qty]" id="qty[]" type="text" class="input" value="{$grouppartslist[i].itemqty}" maxlength="6" /> -->*}<input name="a_grade1" type="text" class="input" value="{$grouppartslist[i].itemqty}" style="max-width: 48%;" disabled /><input type="hidden" name="pid[{$grouppartslist[i].cnt}][itemqty]" id="itemqty[]" value="{$grouppartslist[i].itemqty}">&nbsp;<input name="pid[{$grouppartslist[i].cnt}][qtydata]" id="qtydata[]" type="number" class="input" value="" maxlength="8" style="max-width: 50%;" /></td>
