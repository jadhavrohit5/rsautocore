<div class="pageheading"> <a href="parts.php?mode=show&type=1" class="tooltip back_btn" title="BACK"><i class="fa fa-angle-left"></i></a>
	<h1><i class="fa fa-cogs"></i> EXPORT DATA</h1>
	<div class="add">
					...
					<table>
						...
						<tbody>            
							...
							<tr class="{cycle values="odd,"} itemrow{$gsreqcnt[i].ptypeid}" id="item-r{$gsreqcnt[i].cnt}">
								...
								<td align="center"><span class="action"><a href="export_select_option.php?mode=show&ptype={$gsreqcnt[i].ptypeid}" class="tooltip" title="Select Export Options"><i class="fa fa-file-excel-o"></i></a></span>
								</td>
							</tr>
							{/section} 
						</tbody>
...
jQuery(document).ready(function ($) {
	//Delete item
	 ...
	 $("#page").change(function () {
        ...
        //alert(ppage);
  		var url = 'export_select_type.php?mode=show&p='+ppage;
