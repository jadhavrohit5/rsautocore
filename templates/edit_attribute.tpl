...
<!--
	function valForm(frm)
	{
		...
		if(error.length != 0) {
			...
			frm.pageaction.value = 'updattribute';
			return true;
		}
...
<div class="pageheading"><a href="manage_attributes.php?mode=show" class="tooltip back_btn" title="BACK TO MANAGE ATTRIBUTES"><i class="fa fa-angle-left"></i></a>
	<h1><i class="fa fa-cog"></i> Edit Attribute</h1>
</div>
	...
	<div id="pageBlock">
		...
		<div class="GD-70">
			<div class="form_table">
				<form name="frm" method="post" action="edit_attribute.php?mode=show&attrid={$attrid}" onSubmit="return valForm(this)"> 
					<div class="row">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<thead>
								<tr>
									<th colspan="4" align="left">EDIT ATTRIBUTE</th>
								</tr>
							</thead>
							<tr>
							...
							<tr>
								...
								<td valign="top" colspan="3" width="78%"><input name="attributename" type="text" class="input req alphanumeric" value="{$attributename}" maxlength="150" />
								</td>
							</tr>
						</table>
 					</div>
