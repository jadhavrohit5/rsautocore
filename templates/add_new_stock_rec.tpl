...
{/literal}
<div class="pageheading"><a href="view_part.php?type={$ptypeid}&partid={$partid}&schid={$schid}" class="tooltip back_btn" title="BACK"><i class="fa fa-angle-left"></i></a>
	...
	<div id="pageBlock">
		...
		<div class="GD-70">
			<div class="form_table">
				<form name="frm" method="post" action="add_new_stock_rec.php?type={$ptypeid}&partid={$partid}&schid={$schid}" class="validate disable" onSubmit="return valForm(this)"> 
					<div class="row">
						<table width="100%">
							<thead>
								<tr>
					...
					<div class="row">
						<div id="action_bar">
							...
							<a href="view_part.php?type={$ptypeid}&partid={$partid}&schid={$schid}" class="button btn_gray">Back</a>
						</div>
					</div>
