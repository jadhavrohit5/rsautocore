...
<!--
	function valForm(frm)
	{
		...
		if(error.length != 0) {
			...
			frm.pageaction.value = 'updcustomer';
			return true;
		}
...
<div class="pageheading"><a href="manage_customers.php?mode=show" class="tooltip back_btn" title="BACK TO MANAGE CUSTOMERS"><i class="fa fa-angle-left"></i></a>
	<h1><i class="fa fa-cog"></i> Edit Customer</h1>
</div>
	...
	<div id="pageBlock">
		...
		<div class="GD-70">
			<div class="form_table">
				<form name="frm" method="post" action="edit_customer.php?mode=show&custid={$custid}" onSubmit="return valForm(this)"> 
					<div class="row">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<thead>
								<tr>
									<th colspan="4" align="left">EDIT CUSTOMER</th>
								</tr>
							</thead>
							<tr>
							...
							<tr>
								...
								<td valign="top" colspan="3" width="78%"><input name="custname" type="text" class="input req alphanumeric" value="{$custname}" maxlength="150" />
								</td>
							</tr>
						</table>
 					</div>
