...
if(isset($_POST['pageaction']) && $_POST['pageaction'] == 'addoestock') {
	...
	header('location: edit_item.php?type='.$ptypeid.'&partid='.$partid.'&msg='.base64_encode("New OE Stock record added successfully."));
	die;
}
...
if(isset($_REQUEST['partid'])){  
	...
	$output=$smarty->fetch('add_new_stock.tpl');
