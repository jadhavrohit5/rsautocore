					...
					<table>
						...
						<tbody>            
							...
							<tr class="{cycle values="odd,"} itemrow{$gswebadm[i].webadmid}" id="item-r{$gswebadm[i].cnt}">
								...
								<td align="left" nowrap><span class="MOB">User Login Name:</span> {$gswebadm[i].admusername}</td>
								<td align="left"><span class="MOB">User Full Name:</span> {$gswebadm[i].contactname}</td>
								<td align="left"><span class="MOB">User Type:</span> {$gswebadm[i].usrtypename}</td>
								<td align="right" nowrap><span class="MOB">Date Created:</span> {$gswebadm[i].createdon}</td>
								<td align="right" nowrap><span class="MOB">Last Accessed:</span> {$gswebadm[i].lastlogin}</td>
								...
								<a href="users_mgmt_edit.php?mode=show&id={$gswebadm[i].webadmid}" class="tooltip" title="Edit"><i class="fa fa-file-o"></i></a> 
								<a href="JavaScript:del('users_mgmt.php?mode=show&act=delete&id={$gswebadm[i].webadmid}');" class="tooltip" title="Delete" ><i class="fa fa-trash-o"></i></a></span>
								</td>
							</tr>
							{/section} 
						</tbody>
