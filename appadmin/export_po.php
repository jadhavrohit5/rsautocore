...
$vndid = isset($_REQUEST['id']) ? base64_decode($_REQUEST['id']) : "";

$vendorname = pobe_vendor_name($vndid);
//------------------------------------------------------
...
$podata = $obj_podata->get_partspurchased_export_po_byvendor($vndid);
//echo "-------------------------------------------------------------------------<br><pre>";
//print_r($podata);
//echo "</pre>-------------------------------------------------------------------------<br>";
...
header('Content-Disposition: attachment;filename="PO_'.$vendorname.'.xlsx"');
