...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_63753aec56e658_99776236',
...
function content_63753aec56e658_99776236 (Smarty_Internal_Template $_smarty_tpl) {
?>
				...
				<div class="row">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td valign="top"><input type="text" name="contactperson" value="" class="input req" maxlength="120" style="max-width: 250px;" /></td>
						...
						<tr>
							...
							<td valign="top"><input type="text" name="contactemail" value="" class="input req" maxlength="120" style="max-width: 250px;" /></td>
							<td valign="top"><strong>Contact Phone</strong>:</td>
							<td valign="top"><input type="text" name="contactphone" value="" class="input" maxlength="15" style="max-width: 150px;" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="4" align="left">
																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="1">
								Steering Pumps </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="2">
								Brake Calipers </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="3">
								LHD Steering </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="4">
								RHD Steering </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="5">
								EGR Valves </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="6">
								Diesel Injectors </label>&nbsp;&nbsp;&nbsp;&nbsp;<br>																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="7">
								Diesel Pumps </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="8">
								Driveshafts </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="9">
								Turbocharger </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="10">
								AC Compressor </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="11">
								Alternator </label>&nbsp;&nbsp;&nbsp;&nbsp;																<label>
								<input type="checkbox" name="ptypeopt[]" id="ptypeopt[]" value="12">
								Starter Motor </label>&nbsp;&nbsp;&nbsp;&nbsp;<br>															</td>
						</tr>
						<!-- end  -->
						<!-- 04-08-2021   -->
						<tr>
