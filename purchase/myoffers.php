...
//  added on 18-02-2022 
$vndrcur = pobe_vendor_currency($wuserid);
/*--------------------------------------------------------------------------------*/
...
if(isset($_POST['pageaction']) && $_POST['pageaction'] == 'finalorder') {
	...
	//echo ">>1--<br>";
	$cnt_items = pobe_number_offered_items($vendorid,$wuserid);
	//echo ">>2--<br>";
	$ord_value = pobe_total_offered_value($vendorid,$wuserid);
	//echo ">>3--<br>";
	...
	if ($cnt_items > 0) {
		...
		pobe_insert_supply_data($vendorid,$wuserid,$ponumber);
		//echo ">>5--<br>";
		pobe_cart_temp_data($vendorid,$wuserid);   // added on 29-08-2021 
/*--------------------------------------------------------------------------------*/
		...
		$mgbody .= "TOTAL ORDER VALUE: " . $vndrcur ." ". $ord_value . "<br><br>";
		$mgbody .= "ORDER DATE: " . pobe_format_full_datetime($dateposted) . "<br><br>";
		$mgbody .= pobe_list_supply_data($wuserid,$ponumber,$vndrcur);	
...
//--------------------------------------------------------------------------------//
		...
		$spbody .= "TOTAL ORDER VALUE: " . $vndrcur ." ". $ord_value . "<br><br>";
		$spbody .= "ORDER DATE: " . pobe_format_full_datetime($dateposted) . "<br><br>";
		$spbody .= pobe_list_supply_data($wuserid,$ponumber,$vndrcur);	
		$spbody .= "</p></td></tr></table>";	
		$spbody .= "<p style='font-size:14px;margin-left:20px;'>PLEASE DO NOT REPLY TO THIS EMAIL AS IT WAS GENERATED FROM AN UNMANNED EMAIL ADDRESS.<br><br></p>";	
...
$mail->addCC('Sonny@rsautocore.co.uk');
$mail->addCC('ryan@rsautocore.co.uk');
$mail->addCC('james@rsautocore.co.uk');
...
$spmail->Subject = 'Supply Order successfully posted at Core Purchase System';
