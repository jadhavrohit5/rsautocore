...
$ptypes = [100027, 100551, 102798, 102799, 706379, 100199, 102803, 100354, 100350, 100359, 706373];

$brndno = array();
//$brndno = [30, 66, 83, 89, 114, 161, 214, 226, 234, 292, 293, 393, 479, 4607, 4739];
//$brndno = [30, 66, 83, 89, 114, 161, 214, 226, 234, 292, 293, 393, 479, 4607, 4739, 4742, 4832];
$brndno = [30, 66, 83, 89, 114, 161, 214, 226, 234, 292, 293, 393, 479, 4607, 4739, 4742, 4832, 1, 4381];
...
/*--------------------------------------------------------------------------------*/
	...
	switch($val) {
		...
		case "706379":
			...
			break;
		case "100354":
			$part_type = "AC Compressors";
			break;
		case "100350":
			$part_type = "Alternators";
			break;
		case "100359":
			$part_type = "Starter Motors";
			break;
		case "706373":
			$part_type = "Turbochargers";
			break;
	} 
