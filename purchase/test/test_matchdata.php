...
$brnd_dpi = [30, 66, 83, 89, 393, 479, 4739, 292, 4742, 4832];
	...
	while ($rowBrnd = mysqli_fetch_array($sqlBrnd)){
		...
		if ($rowBrnd['part_type']==10) {
			...
			if (in_array(30, $arrBrnd)) {
				...
				$updSQLb = "UPDATE tbl_rsa_app_matched_articles SET brandopt = '1' WHERE sch_id = '".addslashes($schid)."' AND carid = '".addslashes($carid)."' AND partid = '".addslashes($rowBrnd['partid'])."' AND status = '1' AND brandno = 4742 ";
			} else if (in_array(4739, $arrBrnd)) {
				$updSQLb = "UPDATE tbl_rsa_app_matched_articles SET brandopt = '1' WHERE sch_id = '".addslashes($schid)."' AND carid = '".addslashes($carid)."' AND partid = '".addslashes($rowBrnd['partid'])."' AND status = '1' AND brandno = 4832 ";
			} 
		}
